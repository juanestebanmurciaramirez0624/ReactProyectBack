...
import { readTickets, readTicketsProfile, readTicket, createTickets, updateTickets, deleteTickets  } from "../controllers/ticket.controllers.js"
...
router.get('/ticketsProfile', validateToken, readTicketsProfile )
